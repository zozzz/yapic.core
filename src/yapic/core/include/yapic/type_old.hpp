		...
		protected:
			static inline PyMappingMethods* _MappingMethods() {
				static PyMappingMethods methods = {
					Yapic_GetTypeMethod(Self, __len__),
					Yapic_GetTypeMethod(Self, __getitem__),
					Yapic_GetTypeMethod(Self, __setitem__)
				};
				return &methods;
			}
			...
			static inline PySequenceMethods* _SequenceMethods() {
				static PySequenceMethods methods = {
					Yapic_GetTypeMethod(Self, __len__),
					Yapic_GetTypeMethod(Self, __concat__),
					Yapic_GetTypeMethod(Self, __repeat__),
					...
					Yapic_GetTypeMethod(Self, __contains__),
					Yapic_GetTypeMethod(Self, __inplace_concat__),
					Yapic_GetTypeMethod(Self, __inplace_repeat__)
				};
				return &methods;
			}
